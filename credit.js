...
function labourCamp(scenario){
    ...
    setTimeout(() => {
        if(scenario ==1){
            var speach = ["Sir ",",", " your ", "social ", "credit ", "is ", "low. ","you ", "are ","cringe ","and ", "dissapointment ", "to ", "CCP ", "and ", "you ", "will ", 
            "go ", "to ", "Xinjiang ", "for ", "reeducation. "]
            var grafika = "./grafiki/gulag.jpg"
        }
        if(scenario ==2){
            var speach = ["Sir ",",", " your ", "social ", "credit ", "is ", "so ", "low ", "that ", "Chairman ", "Mao ", "rose ", "from ", "the ", "dead ", "and ", "died ", "again ,",
            "You ",  "have ",  "lowest ",  "social ",  "credit ",  "in ",  "china ",  "and ",  "no ",  "reeducation ",  "can ",  "fix ",  "it. ", "You ",  "will ",  "be ",  "drone-striked. "
        ]
        var grafika = "./grafiki/end.jpg"
    }
        if(scenario ==3){
            var speach = ["Sir, ", "you ", "should ", "not ", "have ", "ignored ", "Chairman Xi, ", "all ", "your ", "social ", "credit ", "is ", "taken ", "away ", "and ", "you ", "are ", "declared ", "enemy ", 
            "of ", "the ", "state "]
            var grafika = "./grafiki/gulag.jpg"
        } 
        if(scenario ==4){
            var speach = ["Sir ", "your ", "social ", "credit ", "score ", "could ", "have ", "been ", "higher ", "but ", "CCP ", "is ", "pleased ", "with ", "your ", "performence, ", "you ", 
        "can ", "continue ", "your ", "daily ", "life. "]
